...
- Kafka client metadata, fetch, produce, offset commit, API version, cluster/config, config-resource discovery, ACL,
  delegation token, client quota, SCRAM credential, broker log directory, KRaft quorum, partition reassignment, active
  producer, transaction, and consumer group inspection APIs.
